...
subplot(4, 2, 3);
plot(t(start_idx:end_idx), yf1_first_last(start_idx:end_idx));
title('First 100 Samples of yf1(n)');
xlabel('Samples');
ylabel('Amplitude');

subplot(4, 2, 4);
plot(t(end-99:end), yf1_first_last(end-99:end));
...
subplot(4, 2, 5);
plot(t(start_idx:end_idx), yf2_first_last(start_idx:end_idx));
title('First 100 Samples of y2(n)');
xlabel('Samples');
ylabel('Amplitude');

subplot(4, 2, 6);
plot(t(end-99:end), yf2_first_last(end-99:end));
title('Last 100 Samples of y2(n)');
xlabel('Samples');
ylabel('Amplitude');

subplot(4, 2, 7);
plot(t(start_idx:end_idx), yf3_first_last(start_idx:end_idx));
title('First 100 Samples of y3(n)');
xlabel('Samples');
ylabel('Amplitude');

subplot(4, 2, 8);
plot(t(end-99:end), yf3_first_last(end-99:end));
title('Last 100 Samples of y3(n)');
xlabel('Samples');
ylabel('Amplitude');
